/*
	This is a modified version of sqlite3.h for use with D.
...
*/
const char[] SQLITE_VERSION = "3.0.0";
...
*/
long sqlite3_last_insert_rowid(sqlite*); // Return type was long long int.
...
*/
void *sqlite3_trace(sqlite*, void function(void*,/+const+/ char*) xTrace, void*);
...
int sqlite3_open16(
  const wchar *filename,   /* Database filename (UTF-16) */
  sqlite3 **ppDb          /* OUT: SQLite db handle */
);
...
** successful.
*/
/+const+/ wchar *sqlite3_errmsg16(sqlite3*);
...
int sqlite3_prepare16(
  sqlite3 *db,            /* Database handle */
  /+const+/ wchar *zSql,       /* SQL statement, UTF-16 encoded */
  int nBytes,             /* Length of zSql in bytes. */
  sqlite3_stmt **ppStmt,  /* OUT: Statement handle */
  /+const+/ wchar **pzTail     /* OUT: Pointer to unused portion of zSql */
);
...
struct sqlite3_value {} //typedef struct Mem sqlite3_value;
...
int sqlite3_bind_int64(sqlite3_stmt*, int, long); // Last parameter type was long long int.
...
/+const+/ wchar *sqlite3_column_name16(sqlite3_stmt*,int);
...
** (i==0).
*/
/+const+/ wchar *sqlite3_column_decltype16(sqlite3_stmt*,int);
...
** 
** SQLITE_ERROR means that a run-time error (such as a /+const+/raint
...
long sqlite3_column_int64(sqlite3_stmt*, int iCol); // Return type was long long int.
/+const+/ char *sqlite3_column_text(sqlite3_stmt*, int iCol);
/+const+/ wchar *sqlite3_column_text16(sqlite3_stmt*, int iCol);
...
** callback. Specifying an in/+const+/ent set of callback values, such as an
...
long sqlite3_value_int64(sqlite3_value*); // Return type was long long int.
/+const+/ char *sqlite3_value_text(sqlite3_value*);
/+const+/ wchar *sqlite3_value_text16(sqlite3_value*);
...
void sqlite3_result_error16(sqlite3_context*, /+const+/ wchar*, int);
void sqlite3_result_int(sqlite3_context*, int);
void sqlite3_result_int64(sqlite3_context*, long); // Last parameter type was long long int.
...
int sqlite3_collation_needed16(
  sqlite3*, 
  void*,
  void function(void*,sqlite3*,int eTextRep,/+const+/ wchar*)
);
